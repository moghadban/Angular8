...
export class EditEntryComponent implements OnInit {
  ...
  constructor(
    ...
    this.entryApi.GetEntry(id).subscribe(data => {
      console.log(data.subjects)
      
      this.entryForm = this.fb.group({
        first_name: [data.first_name , [Validators.required, Validators.minLength]],
        last_name: [data.last_name, [Validators.required, Validators.minLength]],
        phone: [data.phone, [Validators.required, Validators.pattern(this.myreg)]],
        dob: [data.dob, [Validators.required]],
        email: [data.email, [Validators.required, Validators.pattern(this.email_reg)]]
      })
    })
  }
  ...
  UpdateEntryForm() {
    ...
    if (window.confirm('Are you sure you want to update?')) {
      ...
      this.entryApi.UpdateEntry(id, this.entryForm.value).subscribe(res => {
